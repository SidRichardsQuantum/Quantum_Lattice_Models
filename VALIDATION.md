...
| Global spin-flip parity sectors | Parity mappings are orthonormal eigenbases of \(\prod_i X_i\). Open and periodic TFIM parity blocks equal explicit isometric reductions, and the two sector spectra recombine to the full spectrum. | `test_spin_flip_parity_basis_is_an_orthonormal_eigenbasis`, `test_tfim_parity_sectors_match_full_isometric_blocks` |
